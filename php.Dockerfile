...
RUN /bin/bash -c '\
    ...
    ( \
        ...
        apt-key adv --keyserver pgp.mit.edu --recv-keys 14AA40EC0831756756D7F66C4F4EA0AAE5267A6C || \
        apt-key adv --keyserver keyserver.pgp.com --recv-keys 14AA40EC0831756756D7F66C4F4EA0AAE5267A6C \
    ) && \
    apt update && \
